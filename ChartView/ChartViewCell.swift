...
open class ChartViewCell: UITableViewCell {
  ...
  public override init(
    ...
    let cvba = chartView.bottomAnchor.constraint(
    ...
    NSLayoutConstraint.activate([
      ...
      topContentView.leftAnchor.constraint(
        equalTo: contentView.layoutMarginsGuide.leftAnchor,
        constant: -6
      ),
      topContentView.rightAnchor.constraint(
        equalTo: contentView.layoutMarginsGuide.rightAnchor,
        constant: 6
      ),
      ...
      cvba,
      bottomContentView.leftAnchor.constraint(
        equalTo: contentView.layoutMarginsGuide.leftAnchor,
        constant: -6
      ),
      bottomContentView.rightAnchor.constraint(
        equalTo: contentView.layoutMarginsGuide.rightAnchor,
        constant: 6
      ),
