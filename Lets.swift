...
enum Lets {
  ...
  static func deleteConfirmationFor(name: String) -> (
  ...
  static let doneButtonCompletedWeightCompletedRepsKey =
    "Done Button/Completed Weight/Completed Reps"

  static let combineFailAndCompletedWeightAndRepsKey =
    "CombineFailAndCompletedWeightAndReps"
