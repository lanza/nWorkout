...
- (UIView *)createContainerView {
  ...
  gradient.colors =
      [NSArray arrayWithObjects:(id)[[UIColor colorWithRed:218.0 / 255.0
                                                     green:218.0 / 255.0
                                                      blue:218.0 / 255.0
                                                     alpha:1.0f] CGColor],
  ...
  dialogContainer.layer.shadowPath =
      [UIBezierPath
          bezierPathWithRoundedRect:dialogContainer.bounds
                       cornerRadius:dialogContainer.layer.cornerRadius]
          .CGPath;
  ...
  UIView *lineView = [[UIView alloc]
      initWithFrame:CGRectMake(0,
                               dialogContainer.bounds.size.height -
                                   buttonHeight - buttonSpacerHeight,
...
- (void)addButtonsToView:(UIView *)container {
  ...
  for (int i = 0; i < [buttonTitles count]; i++) {
    ...
    [closeButton setTitleColor:[UIColor colorWithRed:0.0f
                                               green:0.5f
                                                blue:1.0f
                                               alpha:1.0f]
                      forState:UIControlStateNormal];
